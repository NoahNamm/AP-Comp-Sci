...
class starter {
		...
		*/
		while(true){
			...
			if (choice.equals("file")){
				...
				System.out.println("Which text file would you like to switch the program to?");
	...
	*/
	public static int checksArray(String[] arr, String check){
		...
		return dupe;	// Dummy value, delete when needed.
	}
	...
	*/
	public static String mostCommon(String[] arr){
		String mostCommon = "There is no most common value";
		int mostDuplicate = 0;
		for (int c = 0; c<arr.length; c++){
			...
			if (duplicate>mostDuplicate){
				mostDuplicate = duplicate;
				mostCommon = arr[c];
			}
		}
		return mostCommon;	// Dummy value, delete when needed.
	}
